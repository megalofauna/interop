...
- **When to check:** For exotic components Material doesn't cover, and to
  see how a kitchen-sink library handles edge cases — _and_ what it gets wrong.
...
- **Known for:** Hook-based a11y primitives backed by Adobe's a11y research.
  Often _more_ rigorous than APG. Comprehensive coverage of locale, RTL,
...
- **Known for:** Not a library — a _catalog of copy-paste React components_
...
- **When to check:** Animation patterns and "delight" affordances — _not_ a
...
- **Watch-outs:** Purely visual — a11y and behavior are on you. Treat as
  a _visual reference_, not a behavioral one.
...
- **When to check:** For "what does this component look like when it's
  _just_ the native element styled well."
...
These are _patterns_, not products. The behavioral source of truth.
