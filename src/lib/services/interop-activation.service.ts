 ...
 * constructor(private interopActivation: InteropActivation) {}
 *
 * ngOnInit() {
 *   const dispose = this.interopActivation.register('save', async (payload) => {
 ...
 *   this.interopActivation.trigger('save', item);
 * }
 *
 * ngOnDestroy() {
 *   this._dispose?.();
...
export class InteropActivation {
	/**
