...
import type { Div, Symb } from '@djot/djot';
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- see contract note above
export type DivRenderer = Type<any>;

/** @deprecated Renderers are duck-typed; this interface is informational only. */
export interface DivRendererInputs {
	node: Div;
}
 ...
 * `NgComponentOutlet`.
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- see DivRenderer contract note
export type SymbolRenderer = Type<any>;

/** @deprecated Renderers are duck-typed; this interface is informational only. */
export interface SymbolRendererInputs {
	node: Symb;
}
