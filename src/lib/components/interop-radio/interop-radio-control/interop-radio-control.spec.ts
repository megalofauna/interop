...
import { InteropRadioControl } from "./interop-radio-control";
...
describe("InteropRadioControl", () => {
  let component: InteropRadioControl;
  let fixture: ComponentFixture<InteropRadioControl>;
  ...
  beforeEach(async () => {
    const activationManagerSpy = jasmine.createSpyObj("InteropActivation", [
      "trigger",
    ]);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: InteropActivation, useValue: activationManagerSpy },
        { provide: InteropAttribute, useValue: attrsManagerSpy },
      ],
    }).compileComponents();

    fixture = TestBed.createComponent(InteropRadioControl);
    ...
    // Target the generated input element
    radioElement = component.getInputElement();
  });
