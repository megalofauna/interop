...
import {
  InteropCheckboxGroup,
  CheckboxControl,
} from "./interop-checkbox-group";
import { InteropAttrs } from "../../services/interop-attrs.service";

const TOPPING_CONTROLS: CheckboxControl[] = [
...
const CONTROLS_WITH_DISABLED: CheckboxControl[] = [
  { id: "pepperoni", value: "pepperoni", label: "Pepperoni" },
...
describe("InteropCheckboxGroup", () => {
  describe("Hands-off + Declarative Mode", () => {
    ...
    it("should render checkbox controls from controls array", () => {
  ...
  describe("Select-All", () => {
    ...
    it("should render a select-all checkbox when enabled", () => {
      const selectAllLabel = groupElement.querySelector(
        ".checkbox-select-all",
      );
    ...
    it("should render 4 checkboxes total (select-all + 3 controls)", () => {
      const checkboxes = groupElement.querySelectorAll(
        'input[type="checkbox"]',
      );
  ...
  describe("Select-All State Derivation", () => {
    let fixture: ComponentFixture<HandsOffDeclarativeHost>;
    let host: HandsOffDeclarativeHost;
    let component: InteropCheckboxGroup;
    ...
    beforeEach(async () => {
      ...
      // Access the InteropCheckboxGroup component instance
  ...
  describe("Select-All with Disabled Items", () => {
    ...
    beforeEach(async () => {
      ...
      fixture = TestBed.createComponent(HandsOffDeclarativeHost);
      host = fixture.componentInstance;
      host.controls = CONTROLS_WITH_DISABLED;
      host.selectAll = true;
  ...
  describe("Content Projection Mode", () => {
    ...
    it("should be in non-declarative mode when no controls are provided", () => {
