...
/**
 * InteropToolbar - Context-driven container for task-specific tools and actions.
 *
 * This component provides a semantic toolbar container with proper ARIA roles and keyboard
  ...
  implements AfterContentInit
{
  ...
  /**
   * Computed tabindex for the host element.
   * -1 when disabled, 0 when enabled and managing focus.
   */
