...
`styles/interop.starter.css` is GENERATED by `scripts/generate-starter.mjs` and is
...
the starter is 19 global knobs and this is 748 per-component ones; burying the
