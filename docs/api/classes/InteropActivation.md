...
# Class: InteropActivation

Defined in: src/lib/services/interop-activation.service.ts:69
...
> **new InteropActivation**(): `InteropActivation`
...
Defined in: src/lib/services/interop-activation.service.ts:95
...
```ts
interopActivation.register('submit', submitOrder, { throttleMs: 500, reentrant: false });
```
...
Defined in: src/lib/services/interop-activation.service.ts:125
...
Defined in: src/lib/services/interop-activation.service.ts:151
...
```ts
interopActivation.trigger('save', item);
interopActivation.trigger('toast', { message: 'Saved!' });
```
...
Defined in: src/lib/services/interop-activation.service.ts:163
...
Defined in: src/lib/services/interop-activation.service.ts:170
...
Defined in: src/lib/services/interop-activation.service.ts:179
...
Defined in: src/lib/services/interop-activation.service.ts:191
...
Defined in: src/lib/services/interop-activation.service.ts:199
...
Defined in: src/lib/services/interop-activation.service.ts:207
