...
<!-- With custom styling -->
<interop-icon name="arrow-right" [size]="32" [strokeWidth]="2" color="blue" />
...
<button class="icon-button">
	<interop-icon name="gear" [decorative]="false" ariaLabel="Open settings" />
</button>
```
...
```html
<interop-icon [name]="isExpanded ? 'caret-up' : 'caret-down'" />
```
