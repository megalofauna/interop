...
/>`;
  ...
  { key: 'status',      label: 'Status' },
	...
	tokenEntries: TokenRow[] = [
		...
		{ groupLabel: "Body" },
		{ property: "--itx-table-body-color", default: "var(--itx-neutral-14)" },
		{
		...
		{ property: "--itx-table-header-color", default: "var(--itx-neutral-14)" },
		...
		{ groupLabel: "Borders" },
		{ property: "--itx-table-border", default: "var(--itx-neutral-8)" },
		...
		{ property: "--itx-table-state-color", default: "var(--itx-neutral-9)" },
		{
