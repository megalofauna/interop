...
/>`;
  ...
  { key: 'status',      label: 'Status' },
	...
	tokenEntries: TokenRow[] = [
		...
		{ groupLabel: "Body" },
		{ property: "--itx-table-body-color", default: "var(--itx-role-text)" },
		{
		...
		{ property: "--itx-table-header-color", default: "var(--itx-role-text)" },
		...
		{ groupLabel: "Borders" },
		{ property: "--itx-table-border", default: "var(--itx-role-edge)" },
		...
		{
			property: "--itx-table-state-color",
