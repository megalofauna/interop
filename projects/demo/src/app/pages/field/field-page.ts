...
<interop-field-textarea itx-size="lg" id="t" label="Large textarea" />`;
	...
	tokenEntries: TokenEntry[] = [
		...
		{ property: "--itx-field-focus-color", default: "var(--itx-colorway)" },
		{ property: "--itx-field-focus-width", default: "2px" },
		{ property: "--itx-field-invalid-color", default: "var(--itx-danger)" },
		...
		{ property: "--itx-field-disabled-color", default: "var(--itx-neutral-7)" },
		{
		...
		{ property: "--itx-field-addon-color", default: "var(--itx-muted)" },
		// Value text
		{
		...
		{ property: "--itx-field-color", default: "var(--itx-on-surface)" },
		{
		...
		// Notes / errors
		{ property: "--itx-field-note-color", default: "var(--itx-muted)" },
		...
		{ property: "--itx-field-error-color", default: "var(--itx-danger)" },
